...
frames=pims.ImageSequence('Data10/images*.png', as_grey=True)     ##import images using pims
...
plt.figure()
f=tp.locate(frames[0],diameter,minmass=900,invert=True)  ##locates features based on args
...
R=tp.locate(frames[0],diameter,minmass=mass,separation=6,invert=True)  ##user define feature params
...
L=tp.batch(frames[:last],diameter,minmass=mass,separation=5,invert=True)
